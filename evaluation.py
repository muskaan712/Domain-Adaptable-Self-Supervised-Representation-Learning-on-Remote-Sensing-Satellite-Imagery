...
columns=['Agriculture', 'Commercial', 'Harbor', 'Idle land', 'Industrial', 'Meadow', 'Overpass', 'Park', 'Pond', 'Residential', 'River','Water'] #name of classes
target_names = ['Agriculture', 'Commercial', 'Harbor', 'Idle land', 'Industrial', 'Meadow', 'Overpass', 'Park', 'Pond', 'Residential', 'River','Water']
print(classification_report(labels, preds, target_names=target_names))
confusion_matrix_df=DataFrame(confm, index=columns, columns=columns)
